...
<?php
  ...
  if(!isset($productos)){
    ...
    //Lo guardo en cookies
    //$productos = serialize($productos);
    setcookie("productos", serialize($productos), time() + 3*24*3600);
  } else {
    //Guardo en productos el array de productos guardado en cookies
    $productos = $_COOKIE['productos'];
    $productos = stripcslashes($productos);
        ...
        <div>
          ...
          ?>
            <div class="col s6 borde">
              ...
              <div class="col s7">
                  <form action="ejer09Detalle.php" method="post">
          ...
          ?>
            ...
            <div class="col s4">
              <div class="col s12">
                <form action="ejer09Productos.php" method="post">
                    <button class="btn waves-effect waves-light green" type="submit" name="action">Administrar productos
