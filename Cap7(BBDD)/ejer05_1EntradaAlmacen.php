    ...
    <section class="card-panel light-blue">
      ...
      <article class="card-panel black-text text-darken-2 grey lighten-3">
        <div>    
          ...
          <h5>¿Cuantas unidades de este artículo desea añadir al almacen?</h5>
          <form action="ejer05_1GestesimalConVenta.php" method="post">
            <input type="hidden" name="codigo" value="<?= $codigo ?>">
            <input type="hidden" name="stoArt" value="<?= $registro->stock ?>">
            <input type="number" name="entrada" min="1" step="1" autofocus required>
            <button class="btn waves-effect waves-light green" type="submit" name="action" value="entradaAlm">Añadir
