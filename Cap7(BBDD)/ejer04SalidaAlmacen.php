    ...
    <section class="card-panel light-blue">
      ...
      <article class="card-panel black-text text-darken-2 grey lighten-3">
        <div>    
          ...
          <h5>¿Cuantas unidades de este artículo desea sacar del almacen?</h5>
          <form action="ejer04Gestesimal.php" method="post">
            ...
            <input type="number" name="salida" min="1" step="1">
            <button class="btn waves-effect waves-light pink" type="submit" name="action" value="salidaAlm">Sacar
